...
const paraData = [
 ...
 Cultural tourism, religious tourism, ecological tourism, educational tourism, health tourism and alpine trekking are our domain of activities. We are visible on all types of social media platforms for information and easy contact.`,
  },
  {
    label: "CEO Message",
    para: `Humans are nomadic specie in search of inner peace and happiness. He/She enjoys exploring his/her self in the context of the physical traces of the past nomadic environment and the extents of mother nature. Me and my team at Gypsy Traces & Tours private limited will make an endeavor to assist you in realization of your inner peace and real happiness.`,
  },
  {
    label: "Our Vision",
  ...
  {
    label: "Our Mission",
    para: `To facilitate our worthy clients in exploring the cultural and natural richness of Pakistan in ecofriendly and cost effective manner.`,
  },
];
